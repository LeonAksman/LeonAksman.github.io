...
* Applying disease progression models, such as Subtype and Stage Inference (SuStaIn; see Alex Young's [paper](https://www.nature.com/articles/s41467-018-05892-0)) to model the spread of Alzheimer's pathologies within the brain. Our most recent [preprint](https://www.biorxiv.org/content/10.1101/2020.12.18.418004v1) applies SuStaIn to (in vivo) amyloid PET, tau PET, CSF and (post mortem) neuropathology based measures to show that there are two Alzheimer's subtypes: an amyloid-first and a tau-first. 
