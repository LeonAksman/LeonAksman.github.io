...
* I am the neuroimaging lead for [LASI-DAD](https://lasi-dad.org/). The goal of my work in this area is to collect and analyze high-quality neuroimaging data (MRI) in India to understand how dementia impacts the brain in low/middle-income countries (LMICs). The majority of dementia cases are expected to occur in LMICs in the coming decades, yet these countries are understudied in dementia research. Recent work in this area is presented at AAIC 2026, [abstract](https://github.com/LeonAksman/LeonAksman.github.io/blob/master/AAIC_2026_MRI_neural_exposome_India.pdf) here.
